...
from common.vcn_ensemble import vcn_ensemble
...
if __name__ == "__main__":
    ...
    parser.add_argument('--step', type=str, required=True, help='Step to run: "train_diffusion", "sample_diffusion", "train_committor", "committor_analysis", "clustering", ""occupancy", "reweighting", "vcn_ensemble"')
    ...
    elif args.step == "vcn_ensemble":
        vcn_ensemble(config['FEL_estimate'])
    
    else:
        raise ValueError(f"Unknown step: {args.step}. Choose from 'train_diffusion', 'sample_diffusion', 'train_committor', 'committor_analysis', 'clustering', 'occupancy', 'reweighting', 'vcn_ensemble'.")       
